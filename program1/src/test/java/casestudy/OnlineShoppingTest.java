...
public class OnlineShoppingTest {
  ...
  public void f() throws InterruptedException {
	  ...
	  d.findElement(By.xpath("//input[@name='userName']")).sendKeys("zxcvbnm");	
	  d.findElement(By.xpath("//input[@name='firstName']")).sendKeys("zxcvbnm");
	  d.findElement(By.xpath("//input[@name='lastName']")).sendKeys("zxcvbnm");
	  d.findElement(By.xpath("//input[@name='password']")).sendKeys("zxcvbnm");
	  d.findElement(By.xpath("//input[@name='confirmPassword']")).sendKeys("zxcvbnm");
